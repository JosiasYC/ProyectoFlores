            ...
            if (detalleId.trim() !== "") {
                ...
                .then(data => {
                    if (data !== "Detalle no encontrado.") {
                        const [pedido_id, producto_id, cantidad, precio_unitario, subtotal] = data.split(",");
...
<body>
    ...
    <form id="actionForm" method="post" action="detallePedido">
        ...
        <input type="text" id="pedido_id" name="pedido_id"><br><br>
